...
def generar() -> None:
    ...
    parametros = [
        ParametroNormativo(idParametro=1, codigo=PNC.SALARIO_MINIMO, nombre="Salario Mínimo Legal Vigente", descripcion="SMMLV Colombia 2026", tipoDato="MONETARIO", valor="1423500", unidad="COP", normaOrigen="Acuerdo 027", articulo="Art. 1", fechaInicioVigencia=date(2026, 1, 1), fechaFinVigencia=date(2026, 12, 31), aplicaA="TODOS", estado="ACTIVO"),
        ...
        ParametroNormativo(idParametro=6, codigo=PNC.PORCENTAJE_PENSION_TRABAJADOR, nombre="Pensión Trabajador %", descripcion="Descuento Pensión 4%", tipoDato="PORCENTUAL", valor="0.04", unidad="%", normaOrigen="Ley 100 de 1993", articulo="Art. 20", fechaInicioVigencia=date(2026, 1, 1), fechaFinVigencia=date(2026, 12, 31), aplicaA="TODOS", estado="ACTIVO"),
        ParametroNormativo(idParametro=7, codigo=PNC.PORCENTAJE_FONDO_SOLIDARIDAD, nombre="Fondo Solidaridad %", descripcion="FSP para IBC >= 4 SMMLV", tipoDato="PORCENTUAL", valor="0.01", unidad="%", normaOrigen="Ley 797 de 2003", articulo="Art. 8", fechaInicioVigencia=date(2026, 1, 1), fechaFinVigencia=date(2026, 12, 31), aplicaA="TODOS", estado="ACTIVO"),
        ParametroNormativo(idParametro=8, codigo=PNC.NOTA_MINIMA_APROBATORIA, nombre="Nota Mínima Aprobatoria", descripcion="Nota mínima aprobar", tipoDato="DECIMAL", valor="3.0", unidad="puntos", normaOrigen="Reglamento Estudiantil", articulo="Art. 45", fechaInicioVigencia=date(2026, 1, 1), fechaFinVigencia=date(2026, 12, 31), aplicaA="ESTUDIANTES", estado="ACTIVO"),
        ParametroNormativo(idParametro=9, codigo=PNC.PROMEDIO_MINIMO_EBRA, nombre="Promedio Mínimo EBRA", descripcion="Umbral de riesgo EBRA", tipoDato="DECIMAL", valor="3.0", unidad="puntos", normaOrigen="Reglamento Estudiantil", articulo="Art. 52", fechaInicioVigencia=date(2026, 1, 1), fechaFinVigencia=date(2026, 12, 31), aplicaA="ESTUDIANTES", estado="ACTIVO"),
        ParametroNormativo(idParametro=10, codigo=PNC.TOPE_BONIFICACION_SERVICIOS, nombre="Tope Bonificación Servicios", descripcion="Tope Decreto 1279", tipoDato="MONETARIO", valor="756411", unidad="COP", normaOrigen="Decreto 1279 de 2002", articulo="Art. 41", fechaInicioVigencia=date(2026, 1, 1), fechaFinVigencia=date(2026, 12, 31), aplicaA="PLANTA", estado="ACTIVO"),
    ]
